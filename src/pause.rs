...
impl Plugin for PausePlugin {
    fn build(&self, app: &mut App) {
        app.add_enter_system(GameState::Pause, setup_pause)
            .add_system_set(
                ConditionSet::new()
...
fn handle_exit_pause(mut commands: Commands, input: Res<Input<KeyCode>>) {
